...
//                 "height", "water", "humus", "carcass", "danger",
...
//              "danger" — встревоженность клетки (DangerComponent) в тех
//              же сотых долях: след того, что здесь недавно охотились. Он
//              же и гонит добычу прочь с настрелянного места, и тем
//              заставляет хищника расходиться по карте (09_Animals.md,
//              п.10a); 0 значит "здесь спокойно".
...
private:
    ...
    struct LayerSnapshot {
        ...
        // Встревоженность клетки (DangerComponent): 0 — здесь спокойно.
