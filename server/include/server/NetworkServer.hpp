...
//        "reach": [x, y, x, y, ...],  -- только у хищника: вся округа, до
//                которой у него есть ход ногами (core/Hunting.hpp). По ней
//                видно, почему он не пошёл за добычей, стоящей на виду за
//                рекой: до неё нет дороги, и добычей она для него не
//                считается
//        "road": [x, y, x, y, ...],  -- дорога до выбранной цели, клетка за
//                клеткой, от первого шага до самой цели. Отсутствует, если
//                идти не за кем или зверь занят не едой
//        "road_kind": "prey"|"carcass"|"teeth",  -- за живой добычей, к туше
//                или добыча уже под зубами (идти некуда, надо бить)
//        "road_x": N, "road_y": N}  -- клетка самой цели
//     Дорога считается тем же законом, каким по ней идёт сам зверь
//     (core/Hunting.hpp), из тех же чисел и с тем же розыгрышем: рисовать
//     дорогу, по которой хищник не идёт, хуже, чем не рисовать никакой.
//     Плоскими парами координат, а не объектами: клеток в округе сотни, и
//     имена полей весили бы больше самих чисел.
