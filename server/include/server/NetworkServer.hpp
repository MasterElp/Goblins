...
//              тайл. Пересчитывать их не нужно ничем: мир и так целый
//              (core/Scale.hpp), и по сети идут ровно те числа, что лежат
//              в компонентах. Прежнего делителя "scale" в протоколе больше
//              нет — делить не на что. moisture, rockiness и growth — в
//              тысячных долях (0..1000), height и water — в тысячных
//              единицы глубины, minerals и humus — счётные величины,
//              species — индекс вида или -1 (клетка пуста). water == 0 значит "воды нет" (на сервере
//              у тайла просто нет WaterComponent), humus == 0 — "перегноя
//              нет". "carcass" — мясо лежащей на тайле падали в тех же
//              тысячных, что и развитость растения, 0 значит "падали нет". "seeds" — вид лежащего в
