...
//      "height": [...],  -- плоский массив, row-major, HeightComponent.height
//              (единиц измерения не несёт, клиент нормализует сам по
//              min/max текущей карты для необязательного слоя-рельефа)
