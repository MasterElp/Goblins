...
//   7. Утоптанность клетки: по натоптанному идти легче, чем по целине.
...
//
// trodden(x, y) — седьмое: насколько умята эта клетка, 0..kFull. Приходит
...
WalkStep chooseStep(MovementComponent& memory, int x, int y, int aimDirection, WalkShy shy,
