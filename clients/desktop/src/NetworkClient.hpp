...
struct WorldState {
    ...
    struct Goblin {
        ...
        // Куда смотрит: +1 вправо, -1 влево. Последний шаг по горизонтали —
        // он и есть направление взгляда; шаг строго вверх или вниз сторону
        // не меняет, иначе идущий по вертикали дёргался бы, выбирая между
        // двумя одинаково неверными ответами.
        int facing = 1;
